...
const inputSchema = zod_1.z.object({
    url: zod_1.z.string().describe("URL to map"),
...
class TavilyMap extends tools_1.StructuredTool {
    static lc_name() {
        return "tavily_map";
    }
    constructor(params = {}) {
        ...
        Object.defineProperty(this, "description", {
            ...
            configurable: true,
            writable: true,
            value: "Creates a comprehensive site map by crawling a website starting from a specified " +
        ...
        if (params.apiWrapper) {
            ...
            this.apiWrapper = new utils_js_1.TavilyMapAPIWrapper(apiWrapperParams);
        }
    ...
    async _call(input, _runManager) {
        try {
            ...
            if (!rawResults ||
                ...
                const errorMessage = `No map results found for '${url}'. ` +
