...
const inputSchema = zod_1.z.object({
    urls: zod_1.z.array(zod_1.z.string()).describe("List of URLs to extract"),
    extractDepth: zod_1.z
        .enum(["basic", "advanced"])
        .optional()
...
class TavilyExtract extends tools_1.StructuredTool {
    static lc_name() {
    ...
    constructor(params = {}) {
        ...
        if (params.apiWrapper) {
            ...
            this.apiWrapper = new utils_js_1.TavilyExtractAPIWrapper(apiWrapperParams);
        }
