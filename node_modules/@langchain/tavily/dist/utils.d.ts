...
export type TavilySearchParams = TavilySearchParamsWithSimpleImages | TavilySearchParamsWithImageDescriptions;
/**
...
export type CrawlCategory = "Documentation" | "Blog" | "Blogs" | "Community" | "About" | "Contact" | "Privacy" | "Terms" | "Status" | "Pricing" | "Enterprise" | "Careers" | "E-Commerce" | "Authentication" | "Developer" | "Developers" | "Solutions" | "Partners" | "Downloads" | "Media" | "Events" | "People";
 ...
 */
export type TavilySearchResponseWithImageDescriptions = TavilyBaseSearchResponse & {
    /**
...
export type TavilySearchResponse = TavilySearchResponseWithImageDescriptions | TavilySearchResponseWithSimpleImages;
/**
 * Base wrapper class with shared functionality for Tavily API wrappers.
 */
declare abstract class BaseTavilyAPIWrapper {
    tavilyApiKey?: string;
    apiBaseUrl?: string;
    /**
     ...
     */
    protected convertCamelToSnakeCase(params: Record<string, unknown>): Record<string, unknown>;
}
/**
 * A wrapper that encapsulates access to the Tavily Search API. Primarily used for testing.
 */
export declare class TavilySearchAPIWrapper extends BaseTavilyAPIWrapper {
    /**
     ...
     */
    rawResults(params: TavilySearchParamsWithSimpleImages): Promise<TavilySearchResponseWithSimpleImages>;
    rawResults(params: TavilySearchParamsWithImageDescriptions): Promise<TavilySearchResponseWithImageDescriptions>;
}
/**
 * A wrapper that encapsulates access to the Tavily Extract API. Primarily used for testing.
 */
export declare class TavilyExtractAPIWrapper extends BaseTavilyAPIWrapper {
    /**
     ...
     */
    rawResults(params: TavilyExtractParams): Promise<TavilyExtractResponse>;
}
/**
 * A wrapper that encapsulates access to the Tavily Crawl API. Primarily used for testing.
 */
export declare class TavilyCrawlAPIWrapper extends BaseTavilyAPIWrapper {
    /**
     ...
     */
    rawResults(params: TavilyCrawlParams): Promise<TavilyCrawlResponse>;
}
/**
 * A wrapper that encapsulates access to the Tavily Map API. Primarily used for testing.
 */
export declare class TavilyMapAPIWrapper extends BaseTavilyAPIWrapper {
    /**
     ...
     */
    rawResults(params: TavilyMapParams): Promise<TavilyMapResponse>;
}
export {};
