...
Serialize.generativeQuery = (generative, opts) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const withImages = (config, imgs, imgProps) =>
      __awaiter(void 0, void 0, void 0, function* () {
    ...
    const provider = generative_js_1.GenerativeProvider.fromPartial({
      returnMetadata: opts === null || opts === void 0 ? void 0 : opts.metadata,
    });
    switch (generative.name) {
      case 'generative-anthropic':
        provider.anthropic = yield withImages(
          generative.config || {},
          opts === null || opts === void 0 ? void 0 : opts.images,
          opts === null || opts === void 0 ? void 0 : opts.imageProperties
        );
        break;
      ...
      case 'generative-google':
        provider.google = yield withImages(
          generative.config || {},
          opts === null || opts === void 0 ? void 0 : opts.images,
          opts === null || opts === void 0 ? void 0 : opts.imageProperties
        );
      ...
      case 'generative-ollama':
        provider.ollama = yield withImages(
          generative.config || {},
          opts === null || opts === void 0 ? void 0 : opts.images,
          opts === null || opts === void 0 ? void 0 : opts.imageProperties
        );
      ...
      case 'generative-openai':
        provider.openai = yield withImages(
          generative.config || {},
          opts === null || opts === void 0 ? void 0 : opts.images,
          opts === null || opts === void 0 ? void 0 : opts.imageProperties
        );
...
Serialize.generative = (args, opts) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const singlePrompt = _a.isSinglePrompt(opts === null || opts === void 0 ? void 0 : opts.singlePrompt)
      ? opts.singlePrompt.prompt
      : opts === null || opts === void 0
      ? void 0
      : opts.singlePrompt;
    const singlePromptDebug = _a.isSinglePrompt(opts === null || opts === void 0 ? void 0 : opts.singlePrompt)
      ? opts.singlePrompt.debug
      : undefined;
    const groupedTask = _a.isGroupedTask(opts === null || opts === void 0 ? void 0 : opts.groupedTask)
      ? opts.groupedTask.prompt
      : opts === null || opts === void 0
      ? void 0
      : opts.groupedTask;
    const groupedProperties = _a.isGroupedTask(opts === null || opts === void 0 ? void 0 : opts.groupedTask)
      ? opts.groupedTask.nonBlobProperties
      : opts === null || opts === void 0
      ? void 0
      : opts.groupedProperties;
    const singleOpts = _a.isSinglePrompt(opts === null || opts === void 0 ? void 0 : opts.singlePrompt)
      ? opts.singlePrompt
      : undefined;
    const groupedOpts = _a.isGroupedTask(opts === null || opts === void 0 ? void 0 : opts.groupedTask)
      ? opts.groupedTask
      : undefined;
      ...
      ? generative_js_1.GenerativeSearch.fromPartial({
          single: (opts === null || opts === void 0 ? void 0 : opts.singlePrompt)
            ? generative_js_1.GenerativeSearch_Single.fromPartial({
                ...
                queries: opts.config ? [yield _a.generativeQuery(opts.config, singleOpts)] : undefined,
              })
            : undefined,
          grouped: (opts === null || opts === void 0 ? void 0 : opts.groupedTask)
            ? generative_js_1.GenerativeSearch_Grouped.fromPartial({
                task: groupedTask,
                queries: opts.config ? [yield _a.generativeQuery(opts.config, groupedOpts)] : undefined,
